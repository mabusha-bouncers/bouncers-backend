...
def is_cloud() -> bool:
    """
        **is_heroku**
            NOTE this environment variable should be set on Cloud RUN -
        :return bool -> True if the application is running on Cloud Run
    """
    return bool(os.environ.get("IS_CLOUD"))
